...
function App(){
  ...
  // ── BON DE TRANSPORT ──
  const LOGO_MRDPS27 = "data:image/png;base64,";
  ...
  const BonTransportView = () => {
    ...
    useEffect(()=>{
      ...
      if(state.activeClient && state.clients[state.activeClient]){
        ...
        setForm(f=>({...f, entrepot:c.name, livNom:c.name}));
      }
    },[]);
    ...
    const updateArticle = (i, key, val) => {
      ...
      setForm({...form, articles:arts});
    };
    const addArticle    = () => setForm({...form, articles:[...form.articles, {ref:"",designation:"",qte:""}]});
    const removeArticle = i  => { if(form.articles.length===1) return; setForm({...form, articles:form.articles.filter((_,idx)=>idx!==i)}); };
    ...
    const saveToHistorique = () => {
      ...
      toast_("Bon sauvegardé dans l'historique");
    };
    ...
    const loadFromHistorique = (entry) => {
      setForm({...entry, numeroBT:genNumBT(), date:new Date().toLocaleDateString("fr-FR")});
    ...
    const printBT = (saveFirst=true) => {
      ...
      const articlesRows = form.articles.map(a=>`
        <tr>
          <td style="padding:9px 10px;border:1px solid #E8ECF1;font-weight:700;color:#2d7a2d">${a.ref||""}</td>
          <td style="padding:9px 10px;border:1px solid #E8ECF1">${a.designation||""}</td>
          <td style="padding:9px 10px;border:1px solid #E8ECF1;text-align:center;font-weight:700">${a.qte||""}</td>
        </tr>`).join("");
...
<style>
  *{box-sizing:border-box;margin:0;padding:0;font-family:Arial,sans-serif;font-size:12px;color:#0D1B2A}
  ...
  body{padding:28px 32px;background:white;display:flex;flex-direction:column;min-height:100vh}
  .page{flex:1;display:flex;flex-direction:column}
  .main{flex:1}
  .header{display:grid;grid-template-columns:170px 1fr 160px;align-items:center;margin-bottom:18px;padding-bottom:14px;border-bottom:3px solid #2d7a2d}
  .bt-title{text-align:center;font-size:18px;font-weight:800;color:#0D1B2A;text-transform:uppercase;letter-spacing:1px}
  .bl-num{text-align:right}
  .bl-label{font-size:9px;color:#888;text-transform:uppercase;letter-spacing:1px}
  .bl-val{font-size:18px;font-weight:800}
  .section-title{font-size:9px;font-weight:700;color:#2d7a2d;text-transform:uppercase;letter-spacing:1.5px;margin:14px 0 8px;border-bottom:1px solid #E8ECF1;padding-bottom:4px}
  .grid2{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:12px}
  .grid3{display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:12px}
  .box{background:#F8FAFC;border:1px solid #E8ECF1;border-radius:6px;padding:12px}
  .box-green{background:#F0FDF4;border:1px solid #ABF5D1;border-radius:6px;padding:12px}
  ...
  .express-row{display:flex;align-items:center;gap:20px;background:#F8FAFC;border:1px solid #E8ECF1;border-radius:6px;padding:9px 14px;margin-bottom:12px}
  ...
  .chk.yes{border-color:#2d7a2d;background:#E3FCEF}
  .chk.yes::after{content:"✓";position:absolute;top:-2px;left:1px;font-size:11px;color:#2d7a2d;font-weight:700}
  table{width:100%;border-collapse:collapse;margin-bottom:12px}
  th{padding:8px 10px;text-align:left;background:#F8FAFC;border:1px solid #E8ECF1;font-size:9px;font-weight:600;color:#8B9BB4;text-transform:uppercase;letter-spacing:.8px}
  .autres{min-height:40px;border:1px solid #E8ECF1;border-radius:6px;padding:9px 12px;color:#4A5568;background:#FAFBFC;margin-bottom:12px;line-height:1.6}
  .sign-row{display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:14px;padding-top:12px;border-top:1px solid #E8ECF1}
  .sign-zone{border:1px dashed #CBD5E0;border-radius:6px;height:52px}
  .footer{padding-top:12px;border-top:2px solid #2d7a2d;text-align:center;font-size:9px;color:#666;line-height:1.8;margin-top:auto}
  @media print{body{padding:14px 18px;-webkit-print-color-adjust:exact;print-color-adjust:exact}@page{margin:.8cm;size:A4}}
</style></head><body>
<div class="page">
<div class="main">
<div class="header">
  <div><img src="${LOGO_MRDPS27}" style="height:70px;width:auto;object-fit:contain"/></div>
  <div class="bt-title">Bon de Transport</div>
  <div class="bl-num">
    <div class="bl-label">N° Bon de transport</div>
    <div class="bl-val">${form.numeroBT}</div>
    <div style="font-size:10px;color:#888;margin-top:2px">${form.date}</div>
  </div>
</div>
<div class="grid2">
  <div class="box">
    ...
    <div style="font-weight:700">M.R.D.P.S 27</div>
    <div style="color:#2d7a2d;font-weight:600;margin-top:2px">Entrepôt : ${form.entrepot||"—"}</div>
    <div style="color:#4A5568;margin-top:4px">5 Rue du Fond du Val — 27600 Saint-Pierre-la-Garenne</div>
    <div style="color:#4A5568;margin-top:2px">Tél : 02 32 21 09 23 — Mobile : 06 47 61 18 28</div>
  </div>
  <div class="box-green">
    <div style="font-size:9px;font-weight:700;color:#006644;text-transform:uppercase;letter-spacing:1px;margin-bottom:8px">Point de livraison</div>
    <div style="font-weight:700">${form.livNom||"—"}</div>
...
<div class="grid3">
  ...
  <div><div class="fl">Site / Entrepôt</div><div class="fv">${form.entrepot||""}</div></div>
      ...
      <div className="anim">
        ...
        {historique.length===0?(
          ...
          <Card p={0} sx={{overflow:"hidden"}}>
            <table style={{width:"100%",borderCollapse:"collapse"}}>
              <thead><tr>
                {["N° BT","Créé le","Entrepôt expéditeur","Point de livraison","Interlocuteur","Articles","Actions"].map(h=>(
              ...
              <tbody>
                {historique.map(e=>(
                  <tr key={e.id} className="row">
                    ...
                    <td style={{padding:"11px 14px",fontSize:12,color:T.txt,borderBottom:`1px solid ${T.bdrD}`}}>{e.entrepot||"—"}</td>
                    <td style={{padding:"11px 14px",fontSize:12,color:T.txt,borderBottom:`1px solid ${T.bdrD}`}}>{e.livNom||"—"}</td>
                    <td style={{padding:"11px 14px",fontSize:12,color:T.txt,borderBottom:`1px solid ${T.bdrD}`}}>{e.interlocuteur||"—"}</td>
                    ...
                    <td style={{padding:"11px 14px",borderBottom:`1px solid ${T.bdrD}`}}>
                      <div style={{display:"flex",gap:6}}>
                        ...
                        <Btn v="secondary" size="sm" onClick={()=>{ setForm({...e}); setShowHistorique(false); printBT(false); }}><Ic n="save" s={12}/>Réimprimer</Btn>
      ...
      <div className="anim">
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20,flexWrap:"wrap",gap:12}}>
          <div>
            ...
            <div style={{fontSize:12,color:T.muted,marginTop:2}}>Tous les champs sont modifiables — sauvegarde automatique à l'impression</div>
          </div>
          <div style={{display:"flex",gap:8}}>
            <Btn v="secondary" onClick={()=>setShowHistorique(true)}>
              <Ic n="history" s={13}/>Historique ({historique.length})
            </Btn>
            <Btn v="secondary" onClick={()=>setForm(f=>({...f,numeroBT:genNumBT()}))}>
              <Ic n="refresh" s={13}/>Nouveau numéro
            </Btn>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:16}}>
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <Card>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                <div><label style={lbl}>N° Bon de transport</label>
                  <input style={{...inp,fontWeight:700,color:T.brand}} value={form.numeroBT} onChange={e=>setForm({...form,numeroBT:e.target.value})}/>
                </div>
                <div><label style={lbl}>Date</label>
                  <input style={inp} value={form.date} onChange={e=>setForm({...form,date:e.target.value})}/>
                </div>
              </div>
            </Card>

            <Card>
              <div style={{fontWeight:600,fontSize:13,color:T.txt,marginBottom:12}}>Expéditeur</div>
              <div style={{background:T.greenBg,border:`1px solid ${T.greenBdr}`,borderRadius:8,padding:"9px 14px",marginBottom:12,fontSize:12,color:T.green,fontWeight:600}}>
                M.R.D.P.S 27 — 5 Rue du Fond du Val, 27600 Saint-Pierre-la-Garenne
              </div>
              <label style={lbl}>Entrepôt / Site d'envoi</label>
              <div style={{display:"flex",gap:8}}>
                <input style={{...inp,flex:1}} value={form.entrepot} onChange={e=>setForm({...form,entrepot:e.target.value})} placeholder="Ex: Entrepôt Nord"/>
                <select style={sel} value="" onChange={e=>{if(e.target.value){const c=state.clients[e.target.value];setForm({...form,entrepot:c.name});}}}>
            ...
            <Card>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                <div><label style={lbl}>Service</label>
                  <input style={inp} value={form.service} onChange={e=>setForm({...form,service:e.target.value})} placeholder="Ex: Informatique, Logistique..."/>
                </div>
                <div><label style={lbl}>Interlocuteur</label>
                  <input style={inp} value={form.interlocuteur} onChange={e=>setForm({...form,interlocuteur:e.target.value})}/>
                </div>
              </div>
            </Card>
              ...
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
                ...
                <div style={{display:"flex",gap:10}}>
                  {[{v:true,l:"OUI"},{v:false,l:"NON"}].map(opt=>(
                    <div key={String(opt.v)} onClick={()=>setForm({...form,express:opt.v})}
            ...
            <Card>
              <div style={{fontWeight:600,fontSize:13,color:T.txt,marginBottom:12}}>Point de livraison</div>
              <div style={{display:"flex",flexDirection:"column",gap:10}}>
                <div><label style={lbl}>Nom / Destinataire</label>
                  <div style={{display:"flex",gap:8}}>
                    <input style={{...inp,flex:1}} value={form.livNom} onChange={e=>setForm({...form,livNom:e.target.value})} placeholder="Nom du destinataire"/>
                    <select style={sel} value="" onChange={e=>{if(e.target.value){const c=state.clients[e.target.value];setForm({...form,livNom:c.name});}}}>
                ...
                <div><label style={lbl}>Adresse complète</label>
                  <textarea value={form.livAdresse} onChange={e=>setForm({...form,livAdresse:e.target.value})}
          ...
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <Card p={0} sx={{overflow:"hidden"}}>
              ...
              <div style={{padding:"8px 12px",borderTop:`1px solid ${T.bdr}`,background:"#F8FAFC"}}>
                <Btn v="secondary" size="sm" onClick={()=>{
                  ...
                  if(items.length>0) setForm({...form,articles:items.map(it=>({ref:it.reference,designation:it.designation,qte:String(it.quantite||"")}))});
            ...
            <Card>
              ...
              <textarea value={form.autreInfo} onChange={e=>setForm({...form,autreInfo:e.target.value})}
            ...
            <div style={{background:T.greenBg,border:`1px solid ${T.greenBdr}`,borderRadius:12,padding:"16px 20px"}}>
              <div style={{fontSize:11,color:T.green,fontWeight:600,textTransform:"uppercase",letterSpacing:.8,marginBottom:6}}>Aperçu du bon</div>
              <div style={{fontSize:24,fontWeight:800,color:T.green,letterSpacing:1}}>{form.numeroBT}</div>
              <div style={{fontSize:12,color:T.green,marginTop:5,lineHeight:1.7}}>
                <div>Entrepôt : {form.entrepot||"—"}</div>
                <div>Livraison : {form.livNom||"—"}</div>
